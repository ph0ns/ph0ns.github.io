const i18nKeyValues = {
    ...
    "junior-programmer": {
        ...
        "es": "Programador júnior",
        "fr": "Programmeur junior",
        "gl": "Programador júnior"
    },
    "software-engineer-rd": {
        "en": "Software engineer at R&D department",
        "es": "Ingeniero de software en el departamento de I+D",
        "fr": "Ingénieur logiciel au département de R&D",
        "gl": "Enxeñeiro de software no departamento de I+D"
    },
    "akka-1": {
    ...
    "akka-3": {
        ...
        "es": "Desarrollo de un programa para el cliente Acore que se comunica con un autómata programable que controla rectificadores. El programa está desarrollado en C# usando WPF y Entity Framework con MySQL.",
        "fr": "Développement d'un logiciel pour le client Acore qui communique avec un automate programmable industriel qui contrôle des redresseurs. Le logiciel est développé en C# en utilisant les frameworks WPF et Entity Framework avec MySQL.",
    ...
    "plexus-1": {
        ...
        "es": "Mantenimiento de software para Barceló Viajes.",
        "fr": "Maintenance des logiciels pour Barceló Viajes.",
        "gl": "Mantemento de software para Barceló Viajes."
    },
    "redegal-1": {
    ...
    "redegal-2": {
        ...
        "es": "Desarrollo de una interfaz web de un sistema de optimización de rutas para servicios de recogida de basura, usando AngularJS y LeafletJS en el front end, Node.js en el back end y un servidor OSRM.",
        "fr": "Développement d'une interface web pour un système d'optimisation des parcours pour les services de ramassage des ordures, en utilisant AnguarJS et LeafletJS dans le front end, Node.js dans le back end et un serveur OSRM.",
        "gl": "Desenvolvemento dunha interface web dun sistema de optimización de rutas para servicios de recollida de basura, empregando AngularJS e LeafletJS no front end, Node.js no back end e un servidor OSRM."
    },
    "it-intern": {
        "en": "IT intern",
        "es": "Prácticas de administrador de sistemas",
        "fr": "Étagiaire d'administrateur système",
        "gl": "Prácticas de administrador de sistemas",
    },
    "concello-1": {
        "en": "System administration in the Town Hall and the Police Department.",
    ...
    "piollo-brief": {
        ...
        "es": "Cliente web para el módulo de la cámara de la Raspberry Pi",
        "fr": "Client web pour le module caméra de Raspberry Pi",
        "gl": "Cliente web para o módulo da cámara da Raspberry Pi"
    },
    "about-piollo-1": {
        "en": "Piollo is a web client for the Raspberry Pi camera module that uses web sockets to stream video. The front end is developed in AngularJS, anthough I want to change it to another technology in the future, and the back end is developed from scratch in Python using the picamera Python module. I didn't use any web framework because I found interesting doing it by myself to learn how to use sockets in this language.",
        "es": "Piollo es un cliente web para el módulo de la cámara de la Raspberry Pi que usa web sockets para streamear vídeo. El front end está desarrollado en AngularJS, aunque quiero canbiarlo por otra tecnología en un futuro, y el back end está desarrollado desde cero en Python usando el módulo picamera de Python. No he utilizado ningún framework web porque me parecía interesante hacerlo por mí mismo para aprender como usar sockets en este lenguaje.",
        "fr": "Piollo est un client web pour le module caméra de Raspberry Pi qui utilise des web sockets pour faire du streaming vidéo. Le front end est developpé en AngularJS, même si je veux le changer pour une autre téchnologie à l'avenir, et le back end est développé à partir de zéro en Python en utilisant le module Python picamera. Je n'ai pas utilisé des frameworks web parce que j'ai trouvé intéressant de le faire par moi-même pour apprendre à utiliser les sockets dans ce langage.",
        "gl": "Piollo é un cliente web para o módulo da cámara da Raspberry Pi que emprega web sockets para streamear vídeo. O front end está desenvolvido en ANgularJS, aínda que quero cambialo por outra tecnoloxía no futuro, e o back end está desenvolvido desde cero en Python empregando o módulo picamera de Python. Non utilicei ningún framework web porque me parecía interesante facelo por min mesmo para aprender como usar sockets nesta linguaxe."
    },
    "about-piollo-2": {
        "en": "I had the idea of doing piollo because, some years ago, after buying the Raspberry Pi, I was wondering what I could do with it. After checking out its available modules, I bought the NoIR Camera module, a camera that doesn't have the IR filter, and I thought, with some IR LEDs, I could have a camera that could be used as a security camera that could see in the dark. But, to access to the camera, I had to connect the Raspberry Pi to a monitor and launch the desktop app. I thought that it would be awesome if it can be accessible from different devices, so, as I couldn't find anything already done at that time to solve this problem, I did it myself.",
        "es": "Tuve la idea de hacer piollo porque, hace unos años, después de comprarme la Raspberry Pi, me preguntaba qué podía hacer con ella. Después de ver sus módulos disponibles, me compré el módulo NoIR Camera, una cámara que no tiene el filtro de infrarrojos, y pensé que, con algunos leds infrarrojos, podía tener una cámara que podría ser utilizada como una cámara de seguridad que pudiese ver en la oscuridad. Pero, para acceder a la cámara, tenía que conectar la Raspberry Pi al monitor y lanzar la aplicación de escritorio. Pensé que sería genial si fuese accesible desde diferentes dispositios, entonces, como no encontraba nada ya hecho en esa época que solucionase ese problema, lo hice yo mismo.",
